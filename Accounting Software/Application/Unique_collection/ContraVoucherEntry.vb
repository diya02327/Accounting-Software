...
Public Class ContraVoucherEntry
    ...
    Private Sub ContraVoucherEntry_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd.Parameters.AddWithValue("@1", "BANK")
        cmd.Parameters.AddWithValue("@2", "CASH")
        ...
        cmd = New SqlCommand("Select DISTINCT OPENING_BALANCE from MNG_LEDGER where OPENING_BALANCE=@1 OR OPENING_BALANCE=@2", con)
        cmd.Parameters.AddWithValue("@1", "BANK")
        cmd.Parameters.AddWithValue("@2", "CASH")

        'cmd = New SqlCommand("select * from MNG_LEDGER where OPENING_BALANCE=@10", con)
        'dap = New SqlDataAdapter(cmd)
        'cmd.Parameters.AddWithValue("@10", txtBalanceDr.Text)
        'ds = New DataSet
        'dap.Fill(ds, "datax")
